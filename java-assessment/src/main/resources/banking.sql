...
CREATE TABLE `account_balance` (
  ...
  `account_pin` varchar(45) DEFAULT NULL,
  `remaining_balance` decimal(19,2) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UK_35gfcexvtm29vparcboprwbdp` (`account_pin`)
...
CREATE TABLE `transaction_history` (
  ...
  `running_balance` decimal(19,2) DEFAULT NULL,
...
-- Dump completed on 2022-03-30  2:33:39
